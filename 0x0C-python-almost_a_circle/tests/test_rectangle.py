...
class TestRectangle(unittest.TestCase):
    ...
    def test_H_class(self):
        '''Tests Rectangle class type.'''
        self.assertEqual(str(Rectangle),
                         "<class 'models.rectangle.Rectangle'>")

    def test_H_inheritance(self):
        '''Tests if Rectangle inherits Base.'''
        self.assertTrue(issubclass(Rectangle, Base))

    def test_H_constructor_no_args(self):
...
and 'height'"
    ...
    def test_H_constructor_many_args(self):
        '''Tests constructor signature.'''
        with self.assertRaises(TypeError) as e:
...
given"
    ...
    def test_H_constructor_one_args(self):
        '''Tests constructor signature.'''
        with self.assertRaises(TypeError) as e:
            r = Rectangle(1)
    ...
    def test_H_instantiation_positional(self):
    ...
    def test_H_instantiation_keyword(self):
        '''Tests positional instantiation.'''
    ...
    def test_H_validate_value_negative_gt(self):
        '''Tests property validation.'''
        r = Rectangle(1, 2)
    ...
    def test_H_validate_value_negative_ge(self):
        '''Tests property validation.'''
        r = Rectangle(1, 2)
        attributes = ["x", "y"]
        for attribute in attributes:
    ...
    def test_H_validate_value_zero(self):
        '''Tests property validation.'''
        r = Rectangle(1, 2)
        attributes = ["width", "height"]
        for attribute in attributes:
    ...
    # ----------------- Tests for task 5 && task 7 ------------------------
    def test_H_display_no_args(self):
    ...
    def test_H_display_simple(self):
...
"""
    ...
    def test_H_str(self):
        ...
        # ----------------- Tests for task8 && task 9 ------------------------
    def test_H_update_no_args(self):
    ...
    def test_H_update_args_bad(self):
    ...
    def test_H_update_kwargs_2(self):
        """Tests update() keyword args"""
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
