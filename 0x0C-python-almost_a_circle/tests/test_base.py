...
class TestBase(unittest.TestCase):
    ...
    def test_H_nb_objects_private(self):
        """Tests if nb_objects is private class attribute."""
        self.assertTrue(hasattr(Base, "_Base__nb_objects"))

    def test_H_nb_objects_inited(self):
    ...
    def test_H_constructor_args_2(self):
        """Tests constructor with 2 notself args"""
        with self.assertRaises(TypeError) as e:
...
were given"
    ...
    def test_H_custom_id_int(self):
        """Tests custom int id"""
        i = 98
        b = Base(i)
        self.assertEqual(b.id, i)

    def test_H_custom_id_str(self):
        """"Tests custom int id"""
        i = "FooBar"
        b = Base(i)
        self.assertEqual(b.id, i)

    def test_H_id_keyword(self):
...
'list_dictionaries'"
    ...
    def test_H_create(self):
        ...
        # ----------------- Tests for task 19 ------------------------
    def test_H_load_from_file(self):
